...
export type CheckboxGroupRootType<T extends CheckboxGroupValueType = CheckboxGroupValueType> = {
	values: T[];
...
export type CheckboxGroupLegendType = {
	children: ReactNode;
	className?: string;
};

export type CheckboxGroupListType = {
	children: ReactNode;
	className?: string;
};

export type CheckboxGroupOptionType<T extends CheckboxGroupValueType = CheckboxGroupValueType> = {
	value: T;
	label: ReactNode;
	id?: string;
	count?: number;
