...
import { type ParsedCatalogSearchParams, type RawUrlSearchParams, type SortOrderType } from '../model/searchParams.types';
...
/**
 * Parses and normalizes catalog-related search params from the URL.
 *
 ...
 *
 * This prevents invalid URL params from leaking into the catalog logic.
 */
export function parseCatalogSearchParams(searchParams: URLSearchParams): ParsedCatalogSearchParams {
