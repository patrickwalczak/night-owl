...
import { useShallowSearchParams } from '@/shared/hooks/useShallowSearchParams';
import { type SearchParamsTypeKeys } from '@/types/catalog.models';

interface ApplyArgs { sort?: string | null; ids?: string[]; query?: string | null }
