		...
		>
			<defs>
				...
				<clipPath id={'g'} clipPathUnits={'userSpaceOnUse'}>
					<path
						...
						strokeWidth={'4.677'}
						d={
							'M-774.546 827.629s12.917-13.473 29.203-13.412c16.53.062 29.203 13.412 29.203 13.412v53.6s-8.825 16-29.203 16c-21.674 0-29.203-16-29.203-16z'
						}
					/>
				</clipPath>
				<clipPath id={'f'} clipPathUnits={'userSpaceOnUse'}>
					<path
						d={
							'M-868.418 945.051c-4.188 73.011 78.255 53.244 150.216 52.941 82.387-.346 98.921-19.444 98.921-47.058 0-27.615-4.788-42.55-73.823-42.55-69.036 0-171.436-30.937-175.314 36.667z'
						}
					/>
				</clipPath>
			</defs>
			...
			<g className={styles.bulb} transform={'translate(844.069 -550.213)'}>
				...
				<path
					...
					strokeWidth={'4'}
					d={
						'M-774.546 827.629s12.917-13.473 29.203-13.412c16.53.062 29.203 13.412 29.203 13.412v0s-8.439 10.115-28.817 10.115c-21.673 0-29.59-10.115-29.59-10.115z'
					}
				/>
				<path
